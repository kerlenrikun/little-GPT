...
class C1Page extends StatefulWidget {
  const C1Page({super.key});

  @override
  State<C1Page> createState() => _C1PageState();
}

class _C1PageState extends BaseDataPage<C1Page> {
  // 获取c1=1的数据项
  @override
  List<SuccDataEntity> get dataList {
    return fullDataList.where((data) => data.c1 == 1).toList();
  }
