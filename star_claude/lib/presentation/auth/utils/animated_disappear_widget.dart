...
class AnimatedDisappearWidget extends StatefulWidget {
  /// 要应用消失动画的子组件
  final Widget child;
  ...
  @override
  State<AnimatedDisappearWidget> createState() => _AnimatedDisappearWidgetState();
}

class _AnimatedDisappearWidgetState extends State<AnimatedDisappearWidget>
