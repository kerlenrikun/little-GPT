...
class UserRepository extends Repository<UserEntity> {
  ...
  Future<dynamic> handleLogin(
    ...
    try {
      ...
      // 登录API
      final results = await CloudApiService().login(
        user_id,
        password,
        remember_me,
      );
      ...
      return {'success': false, 'message': '登录过程中发生错误', 'error': e.toString()};
    }
  }
}
  ...
  //     }
  //   } catch (e) {
  //     return {'success': false, 'message': '注册过程中发生错误', 'error': e.toString()};
  //   }
  // }
  ...
  //     // 检查用户是否存在
  //     if (results.isEmpty) {
  //       return {'success': false, 'message': '用户不存在', 'error': '未找到该手机号对应的用户'};
  //     }
  ...
  //       return {'success': false, 'message': '密码错误', 'error': '密码不匹配'};
  //     }
